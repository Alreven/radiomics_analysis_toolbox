...
CSV_FILE = "icc_fbg_ten_68rdmx.csv"
...
stat, p_value = wilcoxon(icc_2, icc_1, alternative="greater")
...
print("\nTest de Wilcoxon pairé (unilatéral : icc_2 > icc_1)")
...
if p_value < 0.05:
    print("   Les ICC de la condition 2 sont significativement PLUS GRANDS")
